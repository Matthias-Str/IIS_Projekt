...
Bauen uns installieren auf wildlfy per: mvn package wildfly:deploy

Dafür mindestens mavnen version 3.1.x benötigt, auf unserer Vm nicht per sudo-apt möglich, stattdessen per Hand installieren: https://askubuntu.com/questions/420281/how-to-update-maven-3-0-4-3-1-1
...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/manager/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/manager">Camunda BPM Process Application</a></td>
    <td>A Process Application for [Camunda BPM](http://docs.camunda.org).</td>
  </tr>
-->
<!-- Tweet
New @Camunda example: Camunda BPM Process Application - A Process Application for [Camunda BPM](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/manager
-->
