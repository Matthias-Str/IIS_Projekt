...
public class StudentExamWebServiceServiceSoapBindingStub extends org.apache.axis.client.Stub implements thi.iis.project.pruefungen.webservices.StudentExamWebService {
    ...
    public thi.iis.project.pruefungen.webservices.StudentExam getById(int arg0) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://webservices.pruefungen.project.iis.thi/", "getById"));
